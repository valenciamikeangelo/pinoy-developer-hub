...
/**
 * @author Michael Jan 19, 2014
 */
@Configuration
@ComponentScan("com.pdh.persistence")
...
public class HibernateJPAConfigTest {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(
		...
		lef.setPackagesToScan("com.pdh.persistence.model.repository");
		return lef;
	}
	...
	@Bean AccountPersistenceServiceJPA accountPersistenceServiceJPA(){
